...
export default function Inbox() {
  ...
  return (
    <>
      ...
      <BannerCard title="Patent Illustration" imageSrc="/images/banner_img/bg.png" color="white"></BannerCard>
      ...
      {isSubmitted && <OkDialogueBox domainValue={domain} serviceValue={"Patent Illustration"}/> }
